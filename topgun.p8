...
function splashdraw()
    if(t==125) then 
        print("on march 3, 1969 the u.s. navy",3,3,7)
        print("established an elite school of",3,11,7)
        print("the top one percent of its",3,19,7)
        print("pilots. its purpose was to",3,27,7)
        print("teach the lost art of aerial",3,35,7)
        print("combatand to insure that the",3,43,7)
        print("handful of men who graduated",3,51,7)
        print("were the best fighter pilots",3,59,7)
        print("in the world.",3,67,7)
        print("they succeeded.",3,81,7)
        print("today, the navy calls it",3,95,7)
        print("fighter weapons school.",3,103,7)
        print("the flyers call it:",3,119,7)
    end
end
...
function gameinit()
    ...
    dcols={ {1,3,11}, {0,1,13}, {4,9,10}, {13,6,7}, {0,5,6}, {1,2,8}, {3,11,10}}--drop color fades
...
function make_bullet(x,y,dx,dy,dmg,t,fx)
    ...
    if (t!=1) then sfx(52,3) else sfx(53,3) end
    return b
end
   ...
   function move_actor(a)
    ...
    if (a.life/a.mlife<=.25) then
       smoke_make(a.x+a.frsize*2,wobble(a.y,(-.5*a.wob))-a.frsize*2+13,.5+rnd(.5),.1-rnd(.2),2+rnd(2),rnd(2))
    elseif (a.life/a.mlife<=.5)  then 
       smoke_make(a.x+a.frsize*2,wobble(a.y,(-.5*a.wob))-a.frsize*2+13,.5+rnd(.5),.1-rnd(.2),1+rnd(1),rnd(1.5))
    end
    ...
    if (a.k==-1) then --drop move
     ...
     a.frame=a.anm[flr(a.franm)]
     if (a.y>130) del(mobgroup,a)
     if (boxcol(a.x,a.y,8,8,player.x,player.y,16,16)) bar.p+=(bar.w/20) del(mobgroup,a) sfx(55,0)
    end
    if (a.k==-2) then
     a.y+=0.5 a.franm+=0.5 
     if(a.franm>=(count(a.anm)+1)) a.franm=1
     ...
     if (boxcol(a.x,a.y,8,8,player.x,player.y,16,16)) then 
      if (player.life<4) then 
       player.life+=1 sfx(54,0)
       else
       player.dmg=min(player.dmg+1,10) sfx(54,0)
      end
     del(mobgroup,a) 
     end
    end
...
__gfx__

...
442ffffffffff2444444422222244444ffffffffffffffff444445444554444444451445544445445555555515511555465555555555555555555564ffffffff
...

...

...
__sfx__
010100040d6100d6150d6100d61000605076001960024605276002b60015500155001550015500155001550015500155001550015500155001550015505005000050010500105051550015505000000000000000
...

